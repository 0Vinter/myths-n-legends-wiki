...
## Stats
- **Health**: 5 <ModAsset location="mythsandlegends:health_icon" with={9}/>
- **Damage**: 3 <ModAsset location="mythsandlegends:damage_icon" with={9}/>
- **Armor**: 0 <ModAsset location="mythsandlegends:armor_icon" with={9}/>
