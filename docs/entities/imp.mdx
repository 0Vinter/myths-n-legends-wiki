...
## Stats
**Health**: 5 Hp <Asset location="mythsandlegends:health_icon" width={18}/>
<hr/>
**Damage**: 3 Pts <Asset location="mythsandlegends:damage_icon" width={18}/>
<hr/>
**Armor**: 0 Pts <Asset location="mythsandlegends:armor_icon" width={18}/>
