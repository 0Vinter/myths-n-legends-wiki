...
## Stats
- **Health**: 5 <ModAsset location="mythsandlegends:health_icon"/>
- **Damage**: 3 <ModAsset location="mythsandlegends:damage_icon"/>
- **Armor**: 0 <ModAsset location="mythsandlegends:armor_icon"/>
